...
At realm creation screen, upload https://raw.githubusercontent.com/hawtio/hawtio/main/examples/keycloak-integration/hawtio-demo-realm.json[hawtio-demo-realm.json] which defines new `hawtio-demo` realm with pre-configured `hawtio-client` client and 3 users:
