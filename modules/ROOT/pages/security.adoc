...
See https://github.com/hawtio/hawtio/tree/main/examples/quarkus[quarkus example] for a working example of the properties-based authentication.
...
See https://github.com/hawtio/hawtio/tree/main/examples/springboot-security[springboot-security example] for a working example.
