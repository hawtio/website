...
|https://github.com/hawtio/hawtio-next/tree/main/packages/hawtio/src/plugins/diagnostics[Diagnostics (Tech preview)]
|The Diagnostics plugin allows you to retrieve information from your Java runtime. Implements the Java Flight Recorder. 
