...
|https://github.com/hawtio/hawtio-react/tree/main/packages/hawtio/src/plugins/connect[Connect]
...
|https://github.com/hawtio/hawtio-react/tree/main/packages/hawtio/src/plugins/jvm-diagnostics[JVM Diagnostics (Tech preview)]
|The JVM Diagnostics plugin allows you to retrieve information from your Java runtime. Implements the Java Flight Recorder. 

|https://github.com/hawtio/hawtio-react/tree/main/packages/hawtio/src/plugins/jmx[JMX]
...
|https://github.com/hawtio/hawtio-react/tree/main/packages/hawtio/src/plugins/logs[Logs]
...
|https://github.com/hawtio/hawtio-react/tree/main/packages/hawtio/src/plugins/quartz[Quartz]
...
|https://github.com/hawtio/hawtio-react/tree/main/packages/hawtio/src/plugins/runtime[Runtime]
|Provides general overview of the Java process including threads, system properties, and key metrics.

|https://github.com/hawtio/hawtio-react/tree/main/packages/hawtio/src/plugins/springboot[Spring Boot]
...
Apache ActiveMQ Classic plugin:: A https://github.com/afurlane/activemq-classic-hawtio[Hawtio plugin] for https://activemq.apache.org/components/classic/[Apache ActiveMQ Classic] is being actively developed and maintained by the community. This plugin provides essential management capabilities, including:

- Queue and topic browsing
- Consumer and producer views
- Broker metrics and message operations
- JMX-backed management
- A unified console for Camel and ActiveMQ Classic

For more details, visit the project repository:
https://github.com/afurlane/activemq-classic-hawtio
...
https://github.com/hawtio/hawtio/tree/main/examples/sample-plugin +
...
- https://18.react.dev/reference/react[React Reference]
- https://v5-archive.patternfly.org/[PatternFly v5]
