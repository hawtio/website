...
<a class="btn btn-large btn-primary" href="https://oss.sonatype.org/content/repositories/public/io/hawt/hawtio-app/2.7.1/hawtio-app-2.7.1.jar">Download hawtio-app-2.7.1.jar</a>
...
Note: If you launch Hawtio with Java 9+, add the specified modules to avoid errors on startup and allow attaching to other Java processes:
    ...
    java --add-modules jdk.attach,java.xml.bind -jar hawtio-app-2.7.1.jar
...
To set a different port number, run:
    ...
    java -jar hawtio-app-2.7.1.jar --port 8090

To see the full list of configuration options, run:

    java -jar hawtio-app-2.7.1.jar --help
...
<a class="btn btn-large btn-primary" href="https://github.com/hawtio/hawtio/tree/hawtio-2.7.1/examples/springboot">Hawtio Spring Boot example</a>
...
<a class="btn btn-primary" href="https://oss.sonatype.org/content/repositories/public/io/hawt/hawtio-default/2.7.1/hawtio-default-2.7.1.war">Download hawtio-default.war</a>
...
If you do use WildFly, download [hawtio-wildfly-2.7.1.war](https://oss.sonatype.org/content/repositories/public/io/hawt/hawtio-wildfly/2.7.1/hawtio-wildfly-2.7.1.war).
